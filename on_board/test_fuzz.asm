...
;* Date/Time created: Thu Jun 13 14:02:08 2024                                 *
;*******************************************************************************
...
;	/home/santiago/Research/Ti/C55_Tools/acp55 -@/tmp/16485vxIxEr 
	.sect	".text"
	.global	_test
...
$C$DW$13	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$13, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_fuzz.asm:$C$L3:1:1718301728")
...
$C$DW$15	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$15, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_fuzz.asm:$C$L1:1:1718301728")
