...
SECTIONS
{
        ...
        .program_sandbox : > SARAM8 /* Store the device under test here */
        {
        }
        .data_sandbox : {} > SARAM8 				   /* Data may get muddled because of the SUT having a error */
}
