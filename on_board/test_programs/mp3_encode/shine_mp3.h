 ...
 * was written. */
uint16_t *shine_encode_buffer(shine_t s, int16_t **data, int32_t *written);
 ...
 * until the next call to `shine_encode_buffer` or `shine_close` and may be NULL if no data
 * was written. */
uint16_t *shine_encode_buffer_interleaved(shine_t s, int16_t *data, int32_t *written);
...
uint16_t *shine_flush(shine_t s, int32_t *written);
