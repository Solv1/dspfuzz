...
;* Date/Time created: Sat Oct 12 13:48:16 2024                                 *
;*******************************************************************************
...
;	/home/santiago/Research/Ti/C55_Tools/acp55 -@/tmp/40990PfDfcU 
	.sect	".text"
	.global	_sonar_test
...
$C$DW$70	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$70, DW_AT_TI_call
        ...
        MOV T0, *SP(#14) ; |70| 
	.dwpsn	file "./sonar/sonar.c",line 73,column 10,is_stmt
        MOV #0, *SP(#8) ; |73| 
	.dwpsn	file "./sonar/sonar.c",line 73,column 17,is_stmt
        MOV *SP(#2), AR1 ; |73| 
        MOV *SP(#8), AR2 ; |73| 
        CMP AR2 >= AR1, TC1 ; |73| 
        BCC $C$L3,TC1 ; |73| 
...
$C$DW$L$_sonar_test$4$B:
	.dwpsn	file "./sonar/sonar.c",line 74,column 9,is_stmt
        ...
        MOV dbl(*SP(#18)), XAR3
        MOV *AR3(T0), AC0 ; |74| 
        ADD dbl(*SP(#4)), AC0, AC0 ; |74| 
        MOV AC0, dbl(*SP(#4)) ; |74| 
	.dwpsn	file "./sonar/sonar.c",line 73,column 26,is_stmt
        ADD #1, *SP(#8) ; |73| 
	.dwpsn	file "./sonar/sonar.c",line 73,column 17,is_stmt
        MOV *SP(#2), AR1 ; |73| 
        MOV *SP(#8), AR2 ; |73| 
...
$C$L3:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 76,column 5,is_stmt
        MOV *SP(#2), AC1 ; |76| 
        MOV dbl(*SP(#4)), AC0 ; |76| 
$C$DW$71	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$71, DW_AT_low_pc(0x00)
	.dwattr $C$DW$71, DW_AT_name("__divli")
	.dwattr $C$DW$71, DW_AT_TI_call
        CALL #__divli ; |76| 
                                        ; call occurs [#__divli] ; |76| 
        MOV AC0, dbl(*SP(#6)) ; |76| 
	.dwpsn	file "./sonar/sonar.c",line 77,column 5,is_stmt
        MOV #278, AC0 ; |77| 
        MOV dbl(*SP(#6)), AC1 ; |77| 
        CMP AC1 >= AC0, TC1 ; |77| 
        BCC $C$L4,TC1 ; |77| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |77| 
	.dwpsn	file "./sonar/sonar.c",line 79,column 9,is_stmt
        MOV dbl(*SP(#16)), XAR0
$C$DW$72	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$72, DW_AT_TI_call
        CALL #_free ; |79| 
                                        ; call occurs [#_free] ; |79| 
	.dwpsn	file "./sonar/sonar.c",line 80,column 9,is_stmt
        MOV dbl(*SP(#18)), XAR0
$C$DW$73	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$73, DW_AT_TI_call
        CALL #_free ; |80| 
                                        ; call occurs [#_free] ; |80| 
	.dwpsn	file "./sonar/sonar.c",line 81,column 9,is_stmt
        MOV dbl(*SP(#20)), XAR0
...
$C$L4:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 87,column 5,is_stmt
        MOV *SP(#2), AR1 ; |87| 
        MOV AR1, AC0 ; |87| 
        MOV AC0, AR2 ; |87| 
        SFTS AR2, #-1 ; |87| 
...
||      MOV #3, AR2
	...
	.dwpsn	file "./sonar/sonar.c",line 89,column 9,is_stmt
        ...
        SFTS AC1, #-2, AC0 ; |89| 
        MOV AC0, *SP(#10) ; |89| 
	.dwpsn	file "./sonar/sonar.c",line 90,column 5,is_stmt
        B $C$L7   ; |90| 
                                        ; branch occurs ; |90| 
$C$L5:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 91,column 10,is_stmt
        MOV *SP(#2), AC0 ; |91| 

        BFXTR #0x8000, AC0, AR1 ; |91| 
||      MOV #1, AR2
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |91| 
	.dwpsn	file "./sonar/sonar.c",line 92,column 9,is_stmt
        MOV #2, *SP(#11) ; |92| 
	.dwpsn	file "./sonar/sonar.c",line 93,column 9,is_stmt
        MOV *SP(#2), AC0 ; |93| 
        BFXTR #0x8000, AC0, AR1 ; |93| 
        ADD AC0, AR1 ; |93| 
        SFTS AR1, #-1 ; |93| 
        MOV AR1, *SP(#10) ; |93| 
	.dwpsn	file "./sonar/sonar.c",line 94,column 5,is_stmt
        B $C$L7   ; |94| 
                                        ; branch occurs ; |94| 
$C$L6:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 95,column 10,is_stmt
        MOV #3, T1
...
$C$DW$76	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$76, DW_AT_name("__divi")
	.dwattr $C$DW$76, DW_AT_TI_call

        CALL #__divi ; |97| 
||      MOV #3, T1

                                        ; call occurs [#__divi] ; |97| 
        MOV T0, *SP(#10) ; |97| 
$C$L7:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 100,column 5,is_stmt
        MOV *SP(#10), T0 ; |100| 
        MOV *SP(#11), T1 ; |100| 
        MOV dbl(*SP(#18)), XAR0
$C$DW$77	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$77, DW_AT_low_pc(0x00)
	.dwattr $C$DW$77, DW_AT_name("_maxidx")
	.dwattr $C$DW$77, DW_AT_TI_call
        CALL #_maxidx ; |100| 
                                        ; call occurs [#_maxidx] ; |100| 
        MOV T0, *SP(#12) ; |100| 
...
$C$DW$78	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$78, DW_AT_name("_memcpy")
	.dwattr $C$DW$78, DW_AT_TI_call
        CALL #_memcpy ; |106| 
                                        ; call occurs [#_memcpy] ; |106| 
	.dwpsn	file "./sonar/sonar.c",line 107,column 5,is_stmt
        MOV dbl(*SP(#16)), XAR0
        MOV *SP(#2), T0 ; |107| 
$C$DW$79	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$79, DW_AT_low_pc(0x00)
	.dwattr $C$DW$79, DW_AT_name("_calculate_velocity")
	.dwattr $C$DW$79, DW_AT_TI_call
        CALL #_calculate_velocity ; |107| 
                                        ; call occurs [#_calculate_velocity] ; |107| 
        MOV T0, *SP(#13) ; |107| 
...
$C$DW$80	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$80, DW_AT_name("_free")
...
$C$DW$81	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$81, DW_AT_name("_free")
...
$C$DW$82	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$82, DW_AT_name("_free")
...
$C$DW$83	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$83, DW_AT_TI_call
        CALL #_free ; |116| 
                                        ; call occurs [#_free] ; |116| 
	.dwpsn	file "./sonar/sonar.c",line 117,column 5,is_stmt
        MOV dbl(*SP(#18)), XAR0
$C$DW$84	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "./sonar/sonar.c",line 118,column 5,is_stmt
        MOV dbl(*SP(#20)), XAR0
$C$DW$85	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "./sonar/sonar.c",line 120,column 5,is_stmt
        MOV #0, T0
$C$L11:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 121,column 1,is_stmt
        AADD #23, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$87	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$87, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_programs/sonar.asm:$C$L2:1:1728755296")
	.dwattr $C$DW$87, DW_AT_TI_begin_file("./sonar/sonar.c")
	.dwattr $C$DW$87, DW_AT_TI_begin_line(0x49)
	.dwattr $C$DW$87, DW_AT_TI_end_line(0x4b)
$C$DW$88	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$88, DW_AT_low_pc($C$DW$L$_sonar_test$4$B)
	.dwattr $C$DW$88, DW_AT_high_pc($C$DW$L$_sonar_test$4$E)
	.dwendtag $C$DW$87

	.dwattr $C$DW$44, DW_AT_TI_end_file("./sonar/sonar.c")
	.dwattr $C$DW$44, DW_AT_TI_end_line(0x79)
...
$C$DW$89	.dwtag  DW_TAG_subprogram, DW_AT_name("calculate_velocity")
	.dwattr $C$DW$89, DW_AT_low_pc(_calculate_velocity)
	.dwattr $C$DW$89, DW_AT_high_pc(0x00)
	.dwattr $C$DW$89, DW_AT_TI_symbol_name("_calculate_velocity")
	.dwattr $C$DW$89, DW_AT_external
	.dwattr $C$DW$89, DW_AT_type(*$C$DW$T$46)
	.dwattr $C$DW$89, DW_AT_TI_begin_file("./sonar/sonar.c")
	.dwattr $C$DW$89, DW_AT_TI_begin_line(0x7c)
	.dwattr $C$DW$89, DW_AT_TI_begin_column(0x09)
	.dwattr $C$DW$89, DW_AT_TI_max_frame_size(0x12)
	.dwpsn	file "./sonar/sonar.c",line 124,column 55,is_stmt,address _calculate_velocity

	.dwfde $C$DW$CIE, _calculate_velocity
$C$DW$90	.dwtag  DW_TAG_formal_parameter, DW_AT_name("input")
	.dwattr $C$DW$90, DW_AT_TI_symbol_name("_input")
...
_calculate_velocity:
	...
	.dwcfi	save_reg_to_mem, 91, -1
        AADD #-17, SP
	.dwcfi	cfa_offset, 18
$C$DW$92	.dwtag  DW_TAG_variable, DW_AT_name("input")
...
$C$DW$93	.dwtag  DW_TAG_variable, DW_AT_name("size")
	.dwattr $C$DW$93, DW_AT_TI_symbol_name("_size")
...
$C$DW$94	.dwtag  DW_TAG_variable, DW_AT_name("i")
	.dwattr $C$DW$94, DW_AT_TI_symbol_name("_i")
	.dwattr $C$DW$94, DW_AT_type(*$C$DW$T$46)
	.dwattr $C$DW$94, DW_AT_location[DW_OP_bregx 0x24 3]
$C$DW$95	.dwtag  DW_TAG_variable, DW_AT_name("out_buf")
	.dwattr $C$DW$95, DW_AT_TI_symbol_name("_out_buf")
	.dwattr $C$DW$95, DW_AT_type(*$C$DW$T$30)
	.dwattr $C$DW$95, DW_AT_location[DW_OP_bregx 0x24 4]
$C$DW$96	.dwtag  DW_TAG_variable, DW_AT_name("data_buf")
	.dwattr $C$DW$96, DW_AT_TI_symbol_name("_data_buf")
	.dwattr $C$DW$96, DW_AT_type(*$C$DW$T$30)
	.dwattr $C$DW$96, DW_AT_location[DW_OP_bregx 0x24 6]
$C$DW$97	.dwtag  DW_TAG_variable, DW_AT_name("source_movement")
	.dwattr $C$DW$97, DW_AT_TI_symbol_name("_source_movement")
	.dwattr $C$DW$97, DW_AT_type(*$C$DW$T$46)
	.dwattr $C$DW$97, DW_AT_location[DW_OP_bregx 0x24 8]
$C$DW$98	.dwtag  DW_TAG_variable, DW_AT_name("velocity")
	.dwattr $C$DW$98, DW_AT_TI_symbol_name("_velocity")
	.dwattr $C$DW$98, DW_AT_type(*$C$DW$T$46)
	.dwattr $C$DW$98, DW_AT_location[DW_OP_bregx 0x24 9]
$C$DW$99	.dwtag  DW_TAG_variable, DW_AT_name("retVal")
...
$C$DW$100	.dwtag  DW_TAG_variable, DW_AT_name("sum")
	.dwattr $C$DW$100, DW_AT_TI_symbol_name("_sum")
	.dwattr $C$DW$100, DW_AT_type(*$C$DW$T$52)
	.dwattr $C$DW$100, DW_AT_location[DW_OP_bregx 0x24 12]
$C$DW$101	.dwtag  DW_TAG_variable, DW_AT_name("average_f")
	.dwattr $C$DW$101, DW_AT_TI_symbol_name("_average_f")
	.dwattr $C$DW$101, DW_AT_type(*$C$DW$T$46)
	.dwattr $C$DW$101, DW_AT_location[DW_OP_bregx 0x24 14]
$C$DW$102	.dwtag  DW_TAG_variable, DW_AT_name("doppler_f")
	.dwattr $C$DW$102, DW_AT_TI_symbol_name("_doppler_f")
	.dwattr $C$DW$102, DW_AT_type(*$C$DW$T$46)
	.dwattr $C$DW$102, DW_AT_location[DW_OP_bregx 0x24 15]
        MOV T0, *SP(#2) ; |124| 
        MOV XAR0, dbl(*SP(#0))
	.dwpsn	file "./sonar/sonar.c",line 127,column 12,is_stmt
        MOV *SP(#2), T0 ; |127| 
$C$DW$103	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$103, DW_AT_low_pc(0x00)
	.dwattr $C$DW$103, DW_AT_name("_calloc")
	.dwattr $C$DW$103, DW_AT_TI_call

        CALL #_calloc ; |127| 
||      MOV #1, T1

                                        ; call occurs [#_calloc] ; |127| 
        MOV XAR0, dbl(*SP(#4))
	.dwpsn	file "./sonar/sonar.c",line 128,column 12,is_stmt
        MOV *SP(#2), AR1 ; |128| 
        ADD #2, AR1, T0 ; |128| 
$C$DW$104	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$104, DW_AT_low_pc(0x00)
	.dwattr $C$DW$104, DW_AT_name("_calloc")
	.dwattr $C$DW$104, DW_AT_TI_call

        CALL #_calloc ; |128| 
||      MOV #1, T1

                                        ; call occurs [#_calloc] ; |128| 
        MOV XAR0, dbl(*SP(#6))
	.dwpsn	file "./sonar/sonar.c",line 129,column 13,is_stmt
$C$DW$105	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$105, DW_AT_low_pc(0x00)
	.dwattr $C$DW$105, DW_AT_name("_rand")
	.dwattr $C$DW$105, DW_AT_TI_call
        CALL #_rand ; |129| 
                                        ; call occurs [#_rand] ; |129| 
        MOV T0, AC0 ; |129| 

        BFXTR #0x8000, AC0, AR1 ; |129| 
||      MOV #1, AR2
        ...
        SUB AR2, AC0 ; |129| 
        MOV AC0, *SP(#8) ; |129| 
	.dwpsn	file "./sonar/sonar.c",line 130,column 13,is_stmt
        MOV #0, *SP(#9) ; |130| 
	.dwpsn	file "./sonar/sonar.c",line 131,column 11,is_stmt
        MOV #0, *SP(#10) ; |131| 
	.dwpsn	file "./sonar/sonar.c",line 132,column 13,is_stmt
        MOV #0, AC0 ; |132| 
        MOV AC0, dbl(*SP(#12)) ; |132| 
	.dwpsn	file "./sonar/sonar.c",line 133,column 13,is_stmt
        MOV #0, *SP(#14) ; |133| 
	.dwpsn	file "./sonar/sonar.c",line 134,column 13,is_stmt
        MOV #0, *SP(#15) ; |134| 
	.dwpsn	file "./sonar/sonar.c",line 137,column 5,is_stmt
        MOV #20, T1 ; |137| 
        AMOV #_FIR_BANDPASS_TAPS, XAR1 ; |137| 
        MOV *SP(#2), T0 ; |137| 
        MOV dbl(*SP(#0)), XAR0
        MOV dbl(*SP(#4)), XAR2
        MOV dbl(*SP(#6)), XAR3
$C$DW$106	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$106, DW_AT_name("_fir")
	.dwattr $C$DW$106, DW_AT_TI_call
        CALL #_fir ; |137| 
                                        ; call occurs [#_fir] ; |137| 
        MOV T0, *SP(#10) ; |137| 
	.dwpsn	file "./sonar/sonar.c",line 138,column 5,is_stmt
        MOV T0, AR1
        BCC $C$L12,AR1 == #0 ; |138| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |138| 
	.dwpsn	file "./sonar/sonar.c",line 140,column 9,is_stmt
        MOV dbl(*SP(#4)), XAR0
$C$DW$107	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$107, DW_AT_low_pc(0x00)
	.dwattr $C$DW$107, DW_AT_name("_free")
	.dwattr $C$DW$107, DW_AT_TI_call
        CALL #_free ; |140| 
                                        ; call occurs [#_free] ; |140| 
	.dwpsn	file "./sonar/sonar.c",line 141,column 9,is_stmt
        MOV dbl(*SP(#6)), XAR0
$C$DW$108	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$108, DW_AT_low_pc(0x00)
	.dwattr $C$DW$108, DW_AT_name("_free")
	.dwattr $C$DW$108, DW_AT_TI_call
        CALL #_free ; |141| 
                                        ; call occurs [#_free] ; |141| 
	.dwpsn	file "./sonar/sonar.c",line 142,column 9,is_stmt
        MOV #-1, T0
        B $C$L17  ; |142| 
                                        ; branch occurs ; |142| 
$C$L12:    
	...
	.dwpsn	file "./sonar/sonar.c",line 145,column 5,is_stmt
        MOV *SP(#2), AC0 ; |145| 
        MOV dbl(*SP(#4)), XAR0
        BFXTR #0x8000, AC0, T0 ; |145| 
        ADD AC0, T0 ; |145| 
$C$DW$109	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$109, DW_AT_low_pc(0x00)
	.dwattr $C$DW$109, DW_AT_name("_cfft_NOSCALE")
	.dwattr $C$DW$109, DW_AT_TI_call

        CALL #_cfft_NOSCALE ; |145| 
||      SFTS T0, #-1 ; |145| 

                                        ; call occurs [#_cfft_NOSCALE] ; |145| 
        MOV *SP(#2), AC0 ; |145| 
        MOV dbl(*SP(#4)), XAR1
        MOV dbl(*SP(#4)), XAR0
        BFXTR #0x8000, AC0, T0 ; |145| 
...
$C$DW$110	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$110, DW_AT_name("_cbrev")
	.dwattr $C$DW$110, DW_AT_TI_call

        CALL #_cbrev ; |145| 
||      SFTS T0, #-1 ; |145| 

                                        ; call occurs [#_cbrev] ; |145| 
        MOV *SP(#2), T0 ; |145| 
        MOV dbl(*SP(#4)), XAR0
$C$DW$111	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$111, DW_AT_low_pc(0x00)
	.dwattr $C$DW$111, DW_AT_name("_unpack")
	.dwattr $C$DW$111, DW_AT_TI_call
        CALL #_unpack ; |145| 
                                        ; call occurs [#_unpack] ; |145| 
	.dwpsn	file "./sonar/sonar.c",line 147,column 10,is_stmt
        MOV #0, *SP(#3) ; |147| 
	.dwpsn	file "./sonar/sonar.c",line 147,column 17,is_stmt
        MOV *SP(#2), AR1 ; |147| 
        MOV *SP(#3), AR2 ; |147| 
        CMP AR2 >= AR1, TC1 ; |147| 
        BCC $C$L14,TC1 ; |147| 
...
$C$DW$L$_calculate_velocity$4$B:
	.dwpsn	file "./sonar/sonar.c",line 148,column 9,is_stmt
        ...
        MOV dbl(*SP(#4)), XAR3
        MOV *AR3(T0), AC0 ; |148| 
        ADD dbl(*SP(#12)), AC0, AC0 ; |148| 
        MOV AC0, dbl(*SP(#12)) ; |148| 
	.dwpsn	file "./sonar/sonar.c",line 147,column 26,is_stmt
        ADD #1, *SP(#3) ; |147| 
	.dwpsn	file "./sonar/sonar.c",line 147,column 17,is_stmt
        MOV *SP(#2), AR1 ; |147| 
        MOV *SP(#3), AR2 ; |147| 
...
$C$L14:    
	...
	.dwpsn	file "./sonar/sonar.c",line 150,column 5,is_stmt
        MOV *SP(#2), AC1 ; |150| 
        MOV dbl(*SP(#12)), AC0 ; |150| 
$C$DW$112	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$112, DW_AT_low_pc(0x00)
	.dwattr $C$DW$112, DW_AT_name("__divli")
	.dwattr $C$DW$112, DW_AT_TI_call
        CALL #__divli ; |150| 
                                        ; call occurs [#__divli] ; |150| 
        MOV AC0, *SP(#14) ; |150| 
	.dwpsn	file "./sonar/sonar.c",line 153,column 5,is_stmt
        MOV #0, AC0 ; |153| 
        OR #0xc350, AC0, AC0 ; |153| 
        MOV *SP(#14), AC1 ; |153| 
        CMP AC1 <= AC0, TC1 ; |153| 
        BCC $C$L15,TC1 ; |153| 
	CALL #_coverage_log;
	...
	.dwpsn	file "./sonar/sonar.c",line 155,column 9,is_stmt
        MOV #0, AC0 ; |155| 
        OR #0xc350, AC0, AC0 ; |155| 
        ADD *SP(#14), AC0, AC0 ; |155| 
        MOV AC0, *SP(#15) ; |155| 
	.dwpsn	file "./sonar/sonar.c",line 156,column 9,is_stmt
        AMOV #100000, XAR3 ; |156| 
        MOV *SP(#15) << #16, AC0
        MPYK #343, AC0, AC0 ; |156| 
        MOV XAR3, AC1
        MOV mmap(AC0L), AC0 ; |156| 
$C$DW$113	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$113, DW_AT_low_pc(0x00)
	.dwattr $C$DW$113, DW_AT_name("__divli")
	.dwattr $C$DW$113, DW_AT_TI_call
        CALL #__divli ; |156| 
                                        ; call occurs [#__divli] ; |156| 
        MOV AC0, *SP(#9) ; |156| 
...
$C$L15:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 158,column 10,is_stmt

        MOV *SP(#14), AC1 ; |158| 
||      MOV #0, AC0 ; |158| 

        OR #0xc350, AC0, AC0 ; |158| 
        CMP AC1 > AC0, TC1 ; |158| 
        BCC $C$L16,TC1 ; |158| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |158| 
	.dwpsn	file "./sonar/sonar.c",line 160,column 9,is_stmt
        MOV #0, AC0 ; |160| 
        OR #0xc350, AC0, AC0 ; |160| 
        SUB AC0, *SP(#14), AC0 ; |160| 
        MOV AC0, *SP(#15) ; |160| 
	.dwpsn	file "./sonar/sonar.c",line 161,column 9,is_stmt
        AMOV #100000, XAR3 ; |161| 
        MOV *SP(#15) << #16, AC0
        MPYK #343, AC0, AC0 ; |161| 
        MOV XAR3, AC1
        MOV mmap(AC0L), AC0 ; |161| 
$C$DW$114	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$114, DW_AT_low_pc(0x00)
	.dwattr $C$DW$114, DW_AT_name("__divli")
	.dwattr $C$DW$114, DW_AT_TI_call
        CALL #__divli ; |161| 
                                        ; call occurs [#__divli] ; |161| 
        MOV AC0, *SP(#9) ; |161| 
$C$L16:    
	CALL #_coverage_log;
...
$C$DW$115	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$115, DW_AT_name("_free")
	.dwattr $C$DW$115, DW_AT_TI_call
        CALL #_free ; |164| 
                                        ; call occurs [#_free] ; |164| 
	.dwpsn	file "./sonar/sonar.c",line 165,column 5,is_stmt
        MOV dbl(*SP(#6)), XAR0
$C$DW$116	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$116, DW_AT_low_pc(0x00)
	.dwattr $C$DW$116, DW_AT_name("_free")
	.dwattr $C$DW$116, DW_AT_TI_call
        CALL #_free ; |165| 
                                        ; call occurs [#_free] ; |165| 
	.dwpsn	file "./sonar/sonar.c",line 166,column 5,is_stmt
        MOV *SP(#9), T0 ; |166| 
$C$L17:    
	CALL #_coverage_log;
	.dwpsn	file "./sonar/sonar.c",line 167,column 1,is_stmt
        AADD #17, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$118	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$118, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_programs/sonar.asm:$C$L13:1:1728755296")
	.dwattr $C$DW$118, DW_AT_TI_begin_file("./sonar/sonar.c")
	.dwattr $C$DW$118, DW_AT_TI_begin_line(0x93)
	.dwattr $C$DW$118, DW_AT_TI_end_line(0x95)
$C$DW$119	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$119, DW_AT_low_pc($C$DW$L$_calculate_velocity$4$B)
	.dwattr $C$DW$119, DW_AT_high_pc($C$DW$L$_calculate_velocity$4$E)
	.dwendtag $C$DW$118

	.dwattr $C$DW$89, DW_AT_TI_end_file("./sonar/sonar.c")
	.dwattr $C$DW$89, DW_AT_TI_end_line(0xa7)
...
$C$DW$T$19	.dwtag  DW_TAG_const_type
	.dwattr $C$DW$T$19, DW_AT_type(*$C$DW$120)
...
$C$DW$122	.dwtag  DW_TAG_subrange_type
	.dwattr $C$DW$122, DW_AT_upper_bound(0x5a)
	.dwendtag $C$DW$T$37
