...
;* Date/Time created: Thu Oct 17 15:58:20 2024                                 *
;*******************************************************************************
...
;	/home/santiago/Research/Ti/C55_Tools/acp55 -@/tmp/13760qI4nl8 
	.sect	".text"
	.ref _coverage_log;
	.global	_test
...
$C$DW$5	.dwtag  DW_TAG_variable, DW_AT_name("args")
	...
	.dwattr $C$DW$5, DW_AT_location[DW_OP_bregx 0x24 2]
        MOV XAR0, dbl(*SP(#2))
        MOV T0, *SP(#0) ; |14| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 18,column 11,is_stmt
$C$L1:    
$C$DW$L$_test$2$B:
        B $C$L1   ; |18| 
                                        ; branch occurs ; |18| 
...
$C$DW$6	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$6, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_programs/test_fuzz.asm:$C$L1:1:1729195100")
	.dwattr $C$DW$6, DW_AT_TI_begin_file("./sanity_tests/test_fuzz.c")
	.dwattr $C$DW$6, DW_AT_TI_begin_line(0x12)
	.dwattr $C$DW$6, DW_AT_TI_end_line(0x12)
$C$DW$7	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$7, DW_AT_low_pc($C$DW$L$_test$2$B)
	.dwattr $C$DW$7, DW_AT_high_pc($C$DW$L$_test$2$E)
	.dwendtag $C$DW$6
