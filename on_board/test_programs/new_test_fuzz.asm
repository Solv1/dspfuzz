...
;* Date/Time created: Fri Sep 27 08:26:21 2024                                 *
;*******************************************************************************
...
$C$DW$1	.dwtag  DW_TAG_subprogram, DW_AT_name("test")
	...
	.dwattr $C$DW$1, DW_AT_TI_begin_file("./sanity_tests/test_fuzz.c")
	.dwattr $C$DW$1, DW_AT_TI_begin_line(0x0e)
	.dwattr $C$DW$1, DW_AT_TI_begin_column(0x09)
	.dwattr $C$DW$1, DW_AT_TI_max_frame_size(0x06)
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 14,column 45,is_stmt,address _test
...
$C$DW$5	.dwtag  DW_TAG_variable, DW_AT_name("args")
	...
	.dwattr $C$DW$5, DW_AT_location[DW_OP_bregx 0x24 2]
        MOV XAR0, dbl(*SP(#2))
        MOV T0, *SP(#0) ; |14| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 19,column 5,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3, AR1 ; |19| 
...
||      SUB AR2, AR1 ; |19| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |19| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 20,column 9,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#1)), AR1 ; |20| 
...
||      SUB AR2, AR1 ; |20| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |20| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 21,column 13,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#2)), AR1 ; |21| 
...
||      SUB AR2, AR1 ; |21| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |21| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 22,column 17,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#3)), AR1 ; |22| 
...
||      SUB AR2, AR1 ; |22| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |22| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 23,column 21,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#4)), AR1 ; |23| 
...
||      SUB AR2, AR1 ; |23| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |23| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 24,column 25,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#5)), AR1 ; |24| 
...
||      SUB AR2, AR1 ; |24| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |24| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 25,column 29,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#6)), AR1 ; |25| 
...
||      SUB AR2, AR1 ; |25| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |25| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 26,column 33,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(short(#7)), AR1 ; |26| 
...
||      SUB AR2, AR1 ; |26| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |26| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 27,column 37,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV *AR3(#8), AR1 ; |27| 
...
||      SUB AR2, AR1 ; |27| 
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |27| 
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 28,column 47,is_stmt
$C$L1:    
$C$DW$L$_test$11$B:
        B $C$L1   ; |28| 
                                        ; branch occurs ; |28| 
...
$C$L2:    
	CALL #_coverage_log;
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 108,column 5,is_stmt
        MOV #0, T0
	.dwpsn	file "./sanity_tests/test_fuzz.c",line 109,column 1,is_stmt
        AADD #5, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$7	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$7, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_programs/test_fuzz.asm:$C$L1:1:1727439981")
	.dwattr $C$DW$7, DW_AT_TI_begin_file("./sanity_tests/test_fuzz.c")
	.dwattr $C$DW$7, DW_AT_TI_begin_line(0x1c)
	.dwattr $C$DW$7, DW_AT_TI_end_line(0x1c)
$C$DW$8	.dwtag  DW_TAG_TI_loop_range
	...
	.dwattr $C$DW$1, DW_AT_TI_end_file("./sanity_tests/test_fuzz.c")
