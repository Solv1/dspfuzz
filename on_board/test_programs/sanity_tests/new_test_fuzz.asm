...
;* Date/Time created: Thu Aug  1 16:06:18 2024                                 *
;*******************************************************************************
...
;	/home/santiago/Research/Ti/C55_Tools/acp55 -@/tmp/0353113TYHD 
	.sect	".text"
	.ref _coverage_log;
	.global	_test
...
$C$DW$5	.dwtag  DW_TAG_variable, DW_AT_name("args")
	...
	.dwattr $C$DW$5, DW_AT_location[DW_OP_bregx 0x24 2]
        MOV XAR0, dbl(*SP(#2))
        MOV T0, *SP(#0) ; |14| 
	.dwpsn	file "./test_fuzz.c",line 19,column 5,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |19| 
        MOV *AR3, T0 ; |19| 
$C$DW$6	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$6, DW_AT_TI_call
        CALL #__remi ; |19| 
                                        ; call occurs [#__remi] ; |19| 
        MOV #68, AR1 ; |19| 
        CMP T0 != AR1, TC1 ; |19| 
        BCC $C$L2,TC1 ; |19| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |19| 
	.dwpsn	file "./test_fuzz.c",line 20,column 9,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |20| 
        MOV *AR3(short(#1)), T0 ; |20| 
$C$DW$7	.dwtag  DW_TAG_TI_branch
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |20| 
	.dwpsn	file "./test_fuzz.c",line 21,column 13,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |21| 
        MOV *AR3(short(#2)), T0 ; |21| 
$C$DW$8	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$8, DW_AT_low_pc(0x00)
	.dwattr $C$DW$8, DW_AT_name("__remi")
	.dwattr $C$DW$8, DW_AT_TI_call
        CALL #__remi ; |21| 
                                        ; call occurs [#__remi] ; |21| 
        MOV #65, AR1 ; |21| 
        CMP T0 != AR1, TC1 ; |21| 
        BCC $C$L2,TC1 ; |21| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |21| 
	.dwpsn	file "./test_fuzz.c",line 22,column 17,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |22| 
        MOV *AR3(short(#3)), T0 ; |22| 
$C$DW$9	.dwtag  DW_TAG_TI_branch
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |22| 
	.dwpsn	file "./test_fuzz.c",line 23,column 21,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |23| 
        MOV *AR3(short(#4)), T0 ; |23| 
$C$DW$10	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$10, DW_AT_low_pc(0x00)
	.dwattr $C$DW$10, DW_AT_name("__remi")
	.dwattr $C$DW$10, DW_AT_TI_call
        CALL #__remi ; |23| 
                                        ; call occurs [#__remi] ; |23| 
        MOV #66, AR1 ; |23| 
        CMP T0 != AR1, TC1 ; |23| 
        BCC $C$L2,TC1 ; |23| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |23| 
	.dwpsn	file "./test_fuzz.c",line 24,column 25,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |24| 
        MOV *AR3(short(#5)), T0 ; |24| 
$C$DW$11	.dwtag  DW_TAG_TI_branch
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |24| 
	.dwpsn	file "./test_fuzz.c",line 25,column 29,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |25| 
        MOV *AR3(short(#6)), T0 ; |25| 
$C$DW$12	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$12, DW_AT_low_pc(0x00)
	.dwattr $C$DW$12, DW_AT_name("__remi")
	.dwattr $C$DW$12, DW_AT_TI_call
        CALL #__remi ; |25| 
                                        ; call occurs [#__remi] ; |25| 
        CMP T0 != AR1, TC1 ; |25| 
        BCC $C$L2,TC1 ; |25| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |25| 
	.dwpsn	file "./test_fuzz.c",line 26,column 33,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |26| 
        MOV *AR3(short(#7)), T0 ; |26| 
$C$DW$13	.dwtag  DW_TAG_TI_branch
	...
	CALL #_coverage_log;
                                        ; branchcc occurs ; |26| 
	.dwpsn	file "./test_fuzz.c",line 27,column 37,is_stmt
        MOV dbl(*SP(#2)), XAR3
        MOV #127, T1 ; |27| 
        MOV *AR3(#8), T0 ; |27| 
$C$DW$14	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$14, DW_AT_TI_call
        CALL #__remi ; |27| 
                                        ; call occurs [#__remi] ; |27| 
        MOV #33, AR1 ; |27| 
        CMP T0 != AR1, TC1 ; |27| 
        BCC $C$L2,TC1 ; |27| 
	CALL #_coverage_log;
                                        ; branchcc occurs ; |27| 
	.dwpsn	file "./test_fuzz.c",line 28,column 47,is_stmt
$C$L1:    
$C$DW$L$_test$11$B:
        B $C$L1   ; |28| 
                                        ; branch occurs ; |28| 
...
$C$L2:    
	CALL #_coverage_log;
	.dwpsn	file "./test_fuzz.c",line 108,column 5,is_stmt
        MOV #0, T0
	.dwpsn	file "./test_fuzz.c",line 109,column 1,is_stmt
        AADD #5, SP
	.dwcfi	cfa_offset, 1
...
$C$DW$16	.dwtag  DW_TAG_TI_loop
	.dwattr $C$DW$16, DW_AT_name("/home/santiago/Research/DSPFuzz/on_board/test_fuzz.asm:$C$L1:1:1722542779")
	.dwattr $C$DW$16, DW_AT_TI_begin_file("./test_fuzz.c")
	.dwattr $C$DW$16, DW_AT_TI_begin_line(0x1c)
	.dwattr $C$DW$16, DW_AT_TI_end_line(0x1c)
$C$DW$17	.dwtag  DW_TAG_TI_loop_range
	.dwattr $C$DW$17, DW_AT_low_pc($C$DW$L$_test$11$B)
	.dwattr $C$DW$17, DW_AT_high_pc($C$DW$L$_test$11$E)
	.dwendtag $C$DW$16

	.dwattr $C$DW$1, DW_AT_TI_end_file("./test_fuzz.c")
	.dwattr $C$DW$1, DW_AT_TI_end_line(0x6d)
