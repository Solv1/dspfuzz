...
void corner_draw(uint16_t *in, CORNER_LIST corner_list, int32_t x_size, int32_t drawing_mode)
{
    uint16_t *p;
    int32_t n = 0;
...
int16_t susan_corners_quick(uint16_t *in, int32_t *r, uint16_t *bp, int32_t max_no, CORNER_LIST corner_list, int32_t x_size, int32_t y_size)
{
    int32_t n, x, y, i, j;
    uint16_t *p, *cp;
