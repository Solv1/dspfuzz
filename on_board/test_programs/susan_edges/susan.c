...
void edge_draw(uint16_t *in, uint16_t *mid, int32_t x_size, int32_t y_size, int32_t drawing_mode)
{
    int32_t i;
    uint16_t *inp, *midp;
...
void susan_principle_small(uint16_t *in, uint16_t *bp, int32_t *r, int32_t max_no, int32_t x_size, int32_t y_size)
{
    int32_t i, j, n;
    uint16_t *p, *cp;
...
void susan_edges_small(uint16_t *in, int32_t *r, uint16_t *mid, uint16_t *bp, int32_t max_no, int32_t x_size, int32_t y_size)
{
    float z;
...
int16_t susan_edges(uint16_t * in)
{
    uint16_t *bp;
