...
ccsProjects/test_rel_c55l_C55L_COFF/$(CDTFILE): .xdcenv.mak Package.bld Package.mak
	$(ECLIPSE_CMD)  -data "C:/Temp/workspace" -application com.ti.ccstudio.apps.projectCreate -ccs.name test_rel_c55l_C55L_COFF -ccs.device com.ti.ccstudio.deviceModel.C5500.GenericC55xxDevice -ccs.endianness big -ccs.kind com.ti.ccstudio.managedbuild.core.ProjectKind_Executable -ccs.outputType executable -ccs.linkFile EXT_ROOT__TEST_REL_C55L_C55L_COFF_LNKRC55L/test_rel_c55l_ccs.cmd -ccs.linkFile EXT_ROOT__TEST_REL_C55L_C55L_COFF_SRC/veusim.c -ccs.setCompilerOptions "--ptrdiff_size=16 --memory_model=large --symdebug:none -Dti_targets_C55_large -Dxdc_target_types__=ti/targets/std.h  -D__CCS_PROJECT_REL_PATH  -pds1112 -pds825 -pds838 -pds828 -pds827 -pds77 -pds837 -pds824 -vcpu:2.1 -mg -ss -k -dC5510 -as -g --ptrdiff_size=16  -mn -ms -g  -i../../../../../../../ -i$$$${XDC_CG_ROOT}/packages  -i$$$${XDAIS_CG_ROOT}/packages -i../../../lnkr/c55l -i../../../src" @configurations Debug -ccs.setCompilerOptions "--ptrdiff_size=16 --memory_model=large --symdebug:none -Dti_targets_C55_large -Dxdc_target_types__=ti/targets/std.h  -D__CCS_PROJECT_REL_PATH  -pds1112 -pds825 -pds838 -pds828 -pds827 -pds77 -pds837 -pds824 -vcpu:2.1 -mg -ss -k -dC5510 -as -g --ptrdiff_size=16 -o2 -mn -ms  -i../../../../../../../ -i$$$${XDC_CG_ROOT}/packages  -i$$$${XDAIS_CG_ROOT}/packages -i../../../lnkr/c55l -i../../../src" @configurations Release -ccs.location ccsProjects/test_rel_c55l_C55L_COFF -ccs.overwrite full -ccs.rts libc.a -ccs.cgtVersion $(CCSCGTVERC55) -ccs.outputFormat coff -ccs.definePathVariable EXT_ROOT__TEST_REL_C55L_C55L_COFF_LNKRC55L "M:/TI_MAS_VOLIB_2_1_0_1_bldforge/dsps_gtmas/ti/mas/veu/test/lnkr/c55l" -ccs.definePathVariable EXT_ROOT__TEST_REL_C55L_C55L_COFF_SRC "M:/TI_MAS_VOLIB_2_1_0_1_bldforge/dsps_gtmas/ti/mas/veu/test/src"
	${FIXCCSPJT}
...
ccsProjects/test_rel_c55l_C55L_COFF/Debug/test_rel_c55l_C55L_COFF.out: src/veusim.c
ccsProjects/test_rel_c55l_C55L_COFF/Debug/test_rel_c55l_C55L_COFF.out: ccsProjects/test_rel_c55l_C55L_COFF/.project
	...
	$(ECLIPSE_CMD)  -data "C:/Temp/workspace" -application com.ti.ccstudio.apps.projectImport -ccs.projects test_rel_c55l_C55L_COFF -ccs.location "M:/TI_MAS_VOLIB_2_1_0_1_bldforge/dsps_gtmas/ti/mas/veu/test/ccsProjects/test_rel_c55l_C55L_COFF"
