...
COMMONTESTSRCCFLAGS =  -c -pds1112 -pds825 -pds838 -pds828 -pds827 -pds77 -pds837 -pds824 -vcpu:2.1 -mg -ss -k -dC5510 -as -g --ptrdiff_size=16 -o2 -mn -ms
...
$(COMMONTESTSRCCOBJS):lnkr\c55l\test_rel_c55l.x55L.mk
...
lnkr/c55l/test_rel_c55l.x55L :  $(VOLIB_INSTALL_DIR)/ti/mas/veu/lib/veu_c.a55L
...
lnkr/c55l/test_rel_c55l.x55L :  $(COMMONTESTSRCCOBJS)
	@echo lnk55L $@ ...
	$(LD)  $(COMMONTESTSRCCOBJS) lnkr/c55l/test_rel_c55l.cmd $(INTERNALLINKDEFS) $(RTSLIB)
