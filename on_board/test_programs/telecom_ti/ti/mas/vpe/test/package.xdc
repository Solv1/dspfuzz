...
/*! VPE unit test package
 * 
 * @a(NAME)  `ti.mas.vpe.test`
 *
 * @a(DESCRIPTION)
 *
 *        This package creates the VPE unit test system. It depends on the following packages:
 * @p(dlist)
 * - `ti.mas.types`
 * - `ti.mas.fract`
 * - `ti.mas.util`
 ...
 * option = [c55s, c55l, c64le, c64be, c64Ple, c64Pbe, all]
 ...
 * `ti_mas_vpe_test_<arch>_src_<v>_<r>_<x>_<p>.tar` ???? src or obj ???
 * or `ti_mas_vpe_test_all_src_<v>_<r>_<x>_<p>.tar` if option 1="all" ???? src or obj ???
 * 
 * Using the option1 as given and option2="src" creates the released tar file containing source with object code:
 * `ti_mas_vpe_test_<arch>_src_<v>_<r>_<x>_<p>.tar`
 * or `ti_mas_vpe_test_all_src_<v>_<r>_<x>_<p>.tar` if option 1="all"
 *
 * If option2 = "obj" or empty then `ti_mas_vpe_test_all_<v>_<r>_<x>_<p>.tar` is created containing only object code
 *
 * To generate document only the following should be used:
 * `xdc XDCARGS="docs" release` or `xdc XDCARGS="option1,docs"`
 * and `ti_mas_vpe_test_docs_<v>_<r>_<x>_<p>.tar` is created
 * 
...
package ti.mas.vpe.test[2,0,0,0] {
}
