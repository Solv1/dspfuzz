...
public class ti_mas_vpe_test
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("ti.mas.vpe.test.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("ti.mas.vpe.test", new Value.Obj("ti.mas.vpe.test", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("ti.mas.vpe.test.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "ti.mas.vpe.test"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "ti.mas.vpe.test", Value.DEFAULT, false);
        pkgV.bind("$name", "ti.mas.vpe.test");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "ti.mas.vpe.test.");
        ...
        imports.add(Global.newArray("ti.mas.vpe", Global.newArray(4, 0, 1, 0)));
        ...
        sb.append("var pkg = xdc.om['ti.mas.vpe.test'];\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "ti.mas.vpe.test")).add(pkgV);
    }
