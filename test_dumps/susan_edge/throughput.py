...
log_file_path = 'feb_21'  # Change this to your log file's path
...
with open(log_file_path, 'r') as file:
    ...
    for line in file:
        ...
        if time_match and increasing_flag:
            ...
            start_of_test = datetime.strptime('21/02/2025 14:42:39', '%d/%m/%Y %H:%M:%S')  # Change this if the start time is different
