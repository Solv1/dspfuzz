...
log_file_path = 'feb_19'  # Change this to your log file's path
...
with open(log_file_path, 'r') as file:
    ...
    for line in file:
        ...
        if time_match and increasing_flag:
            ...
            start_of_test = datetime.strptime('19/02/2025 10:44:18', '%d/%m/%Y %H:%M:%S')  # Change this if the start time is different
